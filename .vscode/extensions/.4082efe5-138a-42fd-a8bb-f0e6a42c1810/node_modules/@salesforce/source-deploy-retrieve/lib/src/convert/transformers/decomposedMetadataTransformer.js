...
class DecomposedMetadataTransformer extends baseMetadataTransformer_1.BaseMetadataTransformer {
    ...
    ensureValidChildren(component, compSet) {
        var _a;
        compSet = compSet || new collections_1.ComponentSet([], this.registry);
        ...
        for (const child of component.getChildren()) {
            ...
            if (!validChildTypes.includes((_a = child.type) === null || _a === void 0 ? void 0 : _a.id)) {
                const filePath = child.xml || child.content;
                throw new errors_1.TypeInferenceError('error_unexpected_child_type', [
                    filePath,
                    component.type.name,
                ]);
            }
