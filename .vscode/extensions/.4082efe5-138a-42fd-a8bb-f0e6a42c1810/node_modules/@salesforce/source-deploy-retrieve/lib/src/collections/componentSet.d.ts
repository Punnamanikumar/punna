...
import { SourceComponent, MetadataComponent, ComponentLike } from '../resolve';
import { FromManifestOptions, PackageManifestObject, FromSourceOptions, DestructiveChangesType } from './types';
...
export declare class ComponentSet extends LazyCollection<MetadataComponent> {
     ...
     */
    getObject(forDestructiveChanges?: boolean): PackageManifestObject;
    /**
     ...
     */
    getPackageXml(indentation?: number, forDestructiveChanges?: boolean): string;
    /**
    ...
    add(component: ComponentLike, asDeletion?: boolean): void;
    /**
